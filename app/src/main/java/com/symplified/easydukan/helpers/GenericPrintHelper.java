package com.symplified.easydukan.helpers;
...
public class GenericPrintHelper implements Printer {
    ...
    public void printReceipt(Order order, List<Item> items) throws Exception {
        ...
        String title = "\n\t" + (order.store != null ? order.store.name : "EasyDukan Order Chit");
        ...
        prefix.append("\nOrder Type: ");
        prefix.append(order.orderShipmentDetail.storePickup ? "Self-Pickup" : "Delivery");
